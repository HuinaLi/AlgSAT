...
# create logger
logger = logging.getLogger('xoodoo_4r_2331')
...
if __name__ == '__main__':
    ...
    diffs = read_sol(sol_file, ROUNDS, ROUNDS+1)
    if i >= len(diffs):
        raise ValueError("solution file has {} solutions, less than {}".format(len(diffs), i+1))
    xoodoo_mess(diffs[i], ROUNDS)