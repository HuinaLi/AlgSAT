...
ShowUsage() {
    ...
    echo ""
    echo "NOTE:"
    echo "by default, bosphorus is at /home/user/lhn/bosphorus"
    echo "anf_file should be in alg_BASE"
    echo ""
    echo "Example: (gimli)"
    echo "bash $0 /home/user/lhn/bosphorus/gimli 8rgimli 20"
}
...
bos_BASE=/home/user/lhn/bosphorus
alg_BASE=$1
filename=$2
threads=$3
cd ${bos_BASE}
...
nohup python -u /home/user/lhn/bosphorus/keccak/4rkeccak.py -f /home/user/lhn/bosphorus/keccak/trails_1600.txt </dev/null >${alg_BASE}/${filename}.anf 2>&1
