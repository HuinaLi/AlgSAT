...
# create logger
logger = logging.getLogger("4rkeccak_800")
...
if __name__ == '__main__':
    ...
    for i in range(5):
        for j in range(5):
            for k in range(32):
                if (i,j,k) in [(0, 0, 30), (1, 0, 29), (1, 0, 26), (0, 1, 30), (2, 1, 29), (3, 1, 30), (0, 2, 30), (2, 2, 29), (1, 3, 26), (2, 3, 29), (0, 4, 30), (2, 4, 29)]:
                    diff[0][32*(i + 5 * j) + k] = 1
                else:
                    diff[0][32*(i + 5 * j) + k] = 0
    ...
    for i in range(5):
        for j in range(5):
            for k in range(32):
                if (i,j,k) in[(3, 1, 7), (0, 2, 27), (3, 2, 6), (0, 4, 27), (3, 4, 6), (3, 4, 7)]:
                    diff[1][32 * (i + 5 * j) + k] = 1
                else:
                    diff[1][32 * (i + 5 * j) + k] = 0
    ...
    for i in range(5):
        for j in range(5):
            for k in range(32):
                if (i,j,k) in [(2, 1, 30), (2, 2, 31), (4, 2, 13), (4, 3, 30), (4, 3, 31), (1, 4, 30)]:    
                    diff[2][32 * (i + 5 * j) + k] = 1
                else:
                    diff[2][32 * (i + 5 * j) + k] = 0
    ...
    for i in range(5):
        for j in range(5):
            for k in range(32):
                if (i,j,k) in [(0, 0, 13), (2, 0, 9), (2, 0, 10), (3, 0, 21), (3, 0, 3), (4, 0, 12), (0, 1, 28), (0, 1, 10), (2, 1, 16), (4, 1, 27), (2, 2, 25), (2, 2, 7), (3, 2, 6), (3, 2, 7), (4, 2, 31), (1, 3, 17), (3, 3, 14), (4, 3, 24), (4, 3, 6), (0, 4, 28), (1, 4, 23), (1, 4, 5), (2, 4, 20), (3, 4, 22), (4, 4, 0)]:
                    diff[3][32 * (i + 5 * j) + k] = 1
                else:
                    diff[3][32 * (i + 5 * j) + k] = 0
    logger.info(diff[0])
